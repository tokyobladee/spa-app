...
export class CreateCoreSchema1725100000000 implements MigrationInterface {
  name = "CreateCoreSchema1725100000000";
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query("DROP TABLE captcha_challenges");
